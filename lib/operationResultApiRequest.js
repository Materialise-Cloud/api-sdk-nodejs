...
function operationResultApiRequest(operationId, operationName, callback){
	var performRequest = function(token, callback){
		var request = new ApiHttpRequest('/web-api/operation/' + operationId + '/' + operationName + "/result");
...
module.exports = operationResultApiRequest;